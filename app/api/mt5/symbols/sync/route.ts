...
export async function POST(request: NextRequest) {
  try {
    // Authenticate EA using direct API key (from auto-registration)
        ...
        try {
          const spec = await prisma.brokerSymbolSpec.upsert({
            ...
            create: {
              ...
              swapLong: symbolData.swapLong || null,
              swapShort: symbolData.swapShort || null,
              swapType: symbolData.swapType || null,
              currencyBase: symbolData.currencyBase || null,
              currencyProfit: symbolData.currencyProfit || null,
              currencyMargin: symbolData.currencyMargin || null,
